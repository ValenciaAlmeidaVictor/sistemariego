              ...
              <div class="container">
                  <div class="row">
                          <div class="card card-plain">
                              ...
                              <div class="card-body">
                                <form method="POST" action="{{ route('lecturas-sensores.update',$lecturasSensore->id) }}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-group">
                                        <label for="hora_lectura">Hora Lectura</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="valor" id="valor" value="{{ $lecturasSensore->valor }}" class="form-control{{ $errors->has('valor') ? ' is-invalid' : '' }}" placeholder="Valor">
