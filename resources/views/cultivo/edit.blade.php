              ...
              <div class="container">
                  <div class="row">
                          <div class="card card-plain">
                              ...
                              <div class="card-body">
                                <form method="post" action="{{ route('cultivos.update',$cultivo->id )}}">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            <label class="form-label" for="min_humedad"></label>
                                            <div class="input-group input-group-outline mt-3">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            <label class="form-label" for="max_humedad"></label>
                                            <div class="input-group input-group-outline mt-3">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            <label class="form-label" for="min_luminosidad"></label>
                                            <div class="input-group input-group-outline mt-3">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            <label class="form-label" for="max_luminosidad"></label>
                                            <div class="input-group input-group-outline mt-3">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            <label class="form-label" for="min_temperatura"></label>
                                            <div class="input-group input-group-outline mt-3">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            <label class="form-label" for="max_temperatura"></label>
                                            <div class="input-group input-group-outline mt-3">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            <label class="form-label" for="tiempo_crecimiento"></label>
                                            <div class="input-group input-group-outline mt-3">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            <label class="form-label" for="tiempo_vida"></label>
                                            <div class="input-group input-group-outline mt-3">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            <label class="form-label" for="tipo_sembrado"></label>
                                            <div class="input-group input-group-outline mt-3">
