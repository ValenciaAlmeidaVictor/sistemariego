        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white  "
                    href="{{ url('/posts') }}"> <!-- EL URL ES PARA HACER LLAMADOS DE RUTAS CON DATOS -->
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white  "
                    href="{{ url('/clientes') }}"> <!-- EL URL ES PARA HACER LLAMADOS DE RUTAS CON DATOS -->
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-table opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white  "
                    href="{{ url('/index') }}"> <!-- EL URL ES PARA HACER LLAMADOS DE RUTAS CON DATOS -->
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-table opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white  "
                    href="{{ url('/saras') }}"> <!-- EL URL ES PARA HACER LLAMADOS DE RUTAS CON DATOS -->
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-table opacity-10"></i>
                    </div>
            ...
            <li class="nav-item">
                <a class="nav-link text-white  "
                    href="{{ url('/area') }}"> <!-- EL URL ES PARA HACER LLAMADOS DE RUTAS CON DATOS -->
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-table opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Tabla de Areas</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white  "
                    href="{{ url('Plantas') }}"> <!-- EL URL ES PARA HACER LLAMADOS DE RUTAS CON DATOS -->
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-table opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Tipo de Plantas</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link text-white  "
                    href="{{ url('/sensor') }}"> <!-- EL URL ES PARA HACER LLAMADOS DE RUTAS CON DATOS -->
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa-solid fa-table opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Tipo de Sensor</span>
                </a>
            </li>
            <li class="nav-item">
