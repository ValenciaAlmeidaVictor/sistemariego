                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-12 text-left">
                            <a href="{{route('sensor.create')}}" class="btn btn-success btn"><i class="fa-solid fa-circle-plus"></i></a>
                            <a href="{{route('sensor.index')}}"><button type="button" class="btn btn-info">Refrescar</button></a>
                        </div>
                    </div>
                    <br>
