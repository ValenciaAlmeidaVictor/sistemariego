                                ...
                                <div class="card-body">
                                    <form method="post" action="{{ route('plantas.update',$planta->id )}}">
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            ...
                                            <input type="text" class="form-control" name="idTipo"
                                            value="{{($planta->idTipo )}}">
                                        </div>
                                        <div class="input-group input-group-outline mt-3">
                                            <label class="form-label">Max Humedad</label>
                                            <input type="text" class="form-control" name="max_humedad"
                                            value="{{($planta->max_humedad )}}">
                                        </div>
                                        <div class="input-group input-group-outline mt-3">
                                            <label class="form-label">Max Luminusidad</label>
                                            <input type="text" class="form-control" name="max_luminusidad"
                                            value="{{($planta->max_luminusidad )}}">
                                        </div>
