                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$id->cantidad}}</td>
                                        <td>
                                            <form action="{{route('sensores.destroy',$id->id)}}" method="post">
                                                <a href="{{route('sensores.edit',$id->id)}}" class="btn btn-warning btn"><i class="fa-regular fa-pen-to-square"></i></a>
                                                @csrf
                                                @method('DELETE')
