                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Sensores</h6>
                            </div>
                        </div>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tr>
                                        <td>{{$tipo->id}}</td>
                                        <td>{{$tipo->nombre}}</td>
                                        <td>{{$tipo->tipoSensor}}</td>
                                        <td>{{$tipo->costo}}</td>
                                        <td>{{$tipo->cantidad}}</td>
                                        <td>
                                            <form action="{{route('sensores.destroy',$tipo->id)}}" method="post">
                                                <a href="{{route('sensores.edit',$tipo->id)}}" class="btn btn-warning btn"><i class="fa-regular fa-pen-to-square"></i></a>
                                                @csrf
                                                @method('DELETE')
