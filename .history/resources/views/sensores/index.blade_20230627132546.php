                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$Sensores->tipoSensor}}</td>
                                        <td>{{$Sensores->costo}}</td>
                                        <td>{{$Sensores->cantidad}}</td>
                                        <td>
                                            <form action="{{route('sensores.destroy',$Sensores->id)}}" method="post">
                                                <a href="{{route('sensores.edit',$Sensores->id)}}" class="btn btn-warning btn"><i class="fa-regular fa-pen-to-square"></i></a>
                                                @csrf
                                                @method('DELETE')
