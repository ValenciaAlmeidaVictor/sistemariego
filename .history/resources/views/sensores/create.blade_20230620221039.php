...
<div class="modal fade" id="create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('sensores.store')}}" method="post" enctype="multipart/form-data">
        @csrf
      <div class="modal-body">
        ...
        <div class="mb-3">
          ...
          <input type="text"
            class="form-control" name="tipoSensor" id="" aria-describedby="helpId" placeholder="">
        </div>

        <div class="mb-3">
          <label for="" class="form-label">Costo</label>
          <input type="text"
            class="form-control" name="costo" id="" aria-describedby="helpId" placeholder="">
        </div>
