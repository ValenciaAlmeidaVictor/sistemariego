                    ...
                    <div class="row">
                            <div class="card card-plain">
                                <div class="card-header">
                                    <h4 class="font-weight-bolder">Tipos Sensores</h4>
                                    <p class="mb-0">Edite el Registro</p>
                                </div>
                                <div class="card-body">
                                    <form action="{{ route('sensores.update',$tipo->id) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                        ...
                                        <div class="input-group input-group-outline mt-3">
                                            ...
                                            <input type="tex" class="form-control" name="costo"
                                                value="{{$tipo->cantidad}}">
                                        </div>
