                ...
                <div class="row">
                    <div class="col-12">
                        <div class="dropdown show">
                            <a class="btn btn-secondary" href="http://localhost/Valencia-Almeida/public/posts" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              Tabla Invernaderos
                            </a>
                          </div>
                        <div class="card my-4">
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-12 text-left">
                            <a href="{{route('posts.create')}}" class="btn btn-success"><i class="fa-solid fa-circle-plus"></i></a>
                        </div>
                    </div>
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{route('posts.edit', $post->id)}}" class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square"></i></a>
                                            @csrf
                                            @method('DELETE')
