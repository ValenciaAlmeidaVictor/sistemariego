                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-12 text-left">
                            <a href="{{route('Clientes.Registrar')}}" class="btn btn-success btn"><i class="fa-solid fa-circle-plus"></i></a>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('cliente.destroy',$post->id)}}" method="post">
                                                <a href="{{route('cliente.edit',$post->id)}}" class="btn btn-warning btn"><i class="fa-regular fa-pen-to-square"></i></a>
                                                @csrf
                                                @method('DELETE')
