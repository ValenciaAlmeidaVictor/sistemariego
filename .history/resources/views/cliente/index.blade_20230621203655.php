                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-12 text-left">
                            <a href="{{route('cliente.Registrar')}}" class="btn btn-success btn"><i class="fa-solid fa-circle-plus"></i></a>
                            <a href="{{route('cliente.index')}}"><button type="button" class="btn btn-info">Refrescar</button></a>
                        </div>
                    </div>
                    <br>
