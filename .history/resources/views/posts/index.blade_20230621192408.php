        ...
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-12">
                    ...
                    <a href="{{route('posts.index')}}"><button type="button" class="btn btn-secondary">Refrescar</button></a>
                    <br>
                    <br><!--CODIGO PARA EL BUSCADOR-->
                    <div class="container-fluid">
                        <form class="d-flex">
                        <form action="{{route('posts.index')}}" method="GET">
                        <input class="form-control me-2" type="text" placeholder="Buscar con PHP"
