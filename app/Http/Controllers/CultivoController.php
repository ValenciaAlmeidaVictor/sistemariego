...
class CultivoController extends Controller
{
    ...
    {
        $cultivo = new Cultivo();
        $tiposCultivos = TiposCultivo::pluck('tipo', 'id');
        return view('cultivo.create', compact('cultivo','tiposCultivos'));
    }
    ...
    public function edit($id)
    {
        $cultivo = Cultivo::find($id);
        $tiposCultivos = TiposCultivo::pluck('tipo', 'id');
        return view('cultivo.edit', compact('cultivo','tiposCultivos'));
    }
